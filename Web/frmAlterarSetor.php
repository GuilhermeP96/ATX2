...
?>
<body>
<form id="alterarsetor" name="alterarsetor" method="post" action="alterarsetor.php">
  <table width="600" border="1" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td>
				<table>
					<tr>
					  <td colspan="2">Atualização de cadastro de Setor:</td>
					</tr>
					<tr>
					  <td>&nbsp;</td>
					...
					<tr>
					  <td>Nome:</td>
					  <td><label for="nomeSetor"></label>
					  <input name="nomeSetor" type="text" id="nomeSetor" maxlength="20" required="required" value="<?php print $nomeSetor; ?>" /></td>
					</tr>
